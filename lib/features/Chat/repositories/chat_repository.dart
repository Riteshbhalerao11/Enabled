...
import 'package:enabled_try_1/core/common/repositories/common_firebase_storage_repository.dart';
...
import 'package:enabled_try_1/models/message.dart';
  ...
  void sendFileMessage({
    ...
    try {
      ...
      String imageUrl = await ref
          ...
          .storeFileToFirebase(
            'chat/${messageEnum.type}/${senderUserData.username}/$recieverUserId/$messageId',
            file,
          );
